import { Personalize, useNinetailed, useProfile } from '@ninetailed/experience.js-next';
      ...
      <div className="wrapper">
        <div className="container">
          <div id="welcome">
            <Personalize
              id="base"
              text="Non Personalized Hero"
              component={Hero}
              variants={[
                {
                  id: '1',
                  text: "Alex Test - Preview Widget",
                  audience: {
                    id: '123',
                    name: 'Alex Test',
                  },
                ...
                {
                  id: '1',
                  text: "I'm Personalized",
                  audience: {
                    id: 'bc0df78a-e765-41b9-ad60-d64bd5772ed2',
                    name: 'Some Test Audience',
                  },
                },
              ]}
              holdout={0}
